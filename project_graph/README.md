...
```mermaid
graph TD
    %% Định nghĩa các lớp CSS cho node
    ...
    %% 1. Khai báo các Nodes chính kèm Link tài liệu
    User([Người dùng / Client Browser]):::client
    Frontend_App[Frontend App: React Vite SPA<br/>./Frontend_App.md]:::client

    Backend_Main[Backend Main: FastAPI Entrypoint<br/>./Backend_Main.md]:::entry
    Backend_Router_Chatbot[Router Chatbot: chatbot.py<br/>./Backend_Router_Chatbot.md]:::entry
    Backend_Router_Market[Router Market: market_data.py<br/>./Backend_Router_Market.md]:::entry
    Backend_Router_VN30[Router VN30: vn30.py<br/>./Backend_Router_VN30.md]:::entry
    Backend_Schemas[Schemas: chat_schema.py<br/>./Backend_Schemas.md]:::entry

    Backend_Pipeline[Pipeline: chat_pipeline.py<br/>./Backend_Pipeline.md]:::orchestrator
    Backend_Agents[Agents: financial_agent.py<br/>./Backend_Agents.md]:::orchestrator
    Backend_Conversation[Conversation: session_manager.py<br/>./Backend_Conversation.md]:::orchestrator

    Backend_Knowledge_Base[Knowledge Base: Qdrant & SQLite<br/>./Backend_Knowledge_Base.md]:::database

    Backend_LLM[LLM Manager: llm.py & hf_textgen.py<br/>./Backend_LLM.md]:::ai
    Backend_Semantic_Cache[Semantic Cache: cache.py & SQLite<br/>./Backend_Semantic_Cache.md]:::ai
    Backend_Guardrails[Guardrails: guardrails.py<br/>./Backend_Guardrails.md]:::ai
    Backend_Query_Router[Query Router: router.py<br/>./Backend_Query_Router.md]:::ai
    Backend_Embeddings[Embeddings: embeddings.py<br/>./Backend_Embeddings.md]:::ai
    Backend_Reranker[Reranker: reranker.py<br/>./Backend_Reranker.md]:::ai

    Backend_Config[Config Loader: app_config.py<br/>./Backend_Config.md]:::infra
    Backend_App_Mode[App Mode Manager: app_mode.py<br/>./Backend_App_Mode.md]:::infra
    Backend_Market_Exporter[Market Exporter: market_exporter.py<br/>./Backend_Market_Exporter.md]:::infra
    Backend_System_Monitor[System Monitor: logger.py & vram.py<br/>./Backend_System_Monitor.md]:::infra
